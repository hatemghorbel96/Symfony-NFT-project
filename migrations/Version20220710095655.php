 ...
 */
final class Version20220710095655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post ADD owner_id INT DEFAULT NULL, ADD typebuy INT DEFAULT NULL, ADD dateown DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post DROP owner_id, DROP typebuy, DROP dateown');
    }
}
